...
public:
    ...
    void computeError()  {
        ...
        Eigen::Vector3d p3Dc = Tcw.map(p3Dw); //3D point in camera reference system
        Eigen::Vector2d projected = pCamera->project(p3Dc); //project the point
        _error = obs - projected; //compute the rest
...
public:
    ...
    void computeError()  {
        ...
        */
        ...
        Eigen::Vector2d projected = pCamera->project(p3Dc);
